...
// CODE HERE
 const totalPopulation = populations.reduce((accumulativeValue, currentIndexValue) => {
  return accumulativeValue + currentIndexValue
 })
...
// CODE HERE
const salesTax = orders.map(function(num) {
  return num.price * num.tax
})
...
// CODE HERE
const bobsTotal = purchases.filter(element => element.owner === 'Bob')
