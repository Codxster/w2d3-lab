...
//   array.forEach((elem => (elem.id === id ? callback(elem) : null
//     }
  
  
  // getUserById(users, '16t', user =>{
  //   console.log('the user with the id 16t has the email of ' + user.emial + ' the name of' + user.name + 'and the address of' + user.address)
  // })
